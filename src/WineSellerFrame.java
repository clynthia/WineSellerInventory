			...
			public void actionPerformed(ActionEvent arg0) {
				...
				btnOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						int i = 0;
//						do {
//							sandClockImg = new ImageIcon("C:/Users/admin/Google Drive/img/sand-clock1.png");
//							imgLabel = new JLabel(sandClockImg);
//							imgLabel.setBounds(268, 147, 128, 104);
//							//imgLabel.setVisible(true);
//							genReportPanel.add(imgLabel);
//							
//							sandClockImg = new ImageIcon("C:/Users/admin/Google Drive/img/sand-clock2.png");
//							imgLabel = new JLabel(sandClockImg);
//							imgLabel.setBounds(268, 147, 128, 104);
//							//imgLabel.setVisible(true);
//							genReportPanel.add(imgLabel);
//							
//							sandClockImg = new ImageIcon("C:/Users/admin/Google Drive/img/sand-clock3.png");
//							imgLabel = new JLabel(sandClockImg);
//							imgLabel.setBounds(268, 147, 128, 104);
//							//imgLabel.setVisible(true);
//							genReportPanel.add(imgLabel);
//							
//							sandClockImg = new ImageIcon("C:/Users/admin/Google Drive/img/sand-clock4.png");
//							imgLabel = new JLabel(sandClockImg);
//							imgLabel.setBounds(268, 147, 128, 104);
//							//imgLabel.setVisible(true);
//							genReportPanel.add(imgLabel);
...
//						} while(i != 500);
							...
							//prints report and
							//saves report as pdf into a pc
							closeout.generateReport();
							//closeout Reports have:
						//hours of opeartions (open during 17hrs. From 9:00 am till 2:00 am)
						//compare today's report with estimations
						//For example: 
						//actual values of today (WED 10/16/2013) compared with estimations((WED 10/17/2012* WED 10/19/2011) / 2)
						//values separated in categories:
						//- champagne/brut/cava
						//- wines
						//- liquors
						//
